...
| M07 | watcher | 文件监控 | `FileWatcher.start() -> dict` | watchdog + 防抖 |
...
| G04 |  | v0.3 动态更新 | 文件监控 + 热词热更新 | done | G03 |  | accepted | passed | 2026-03-20 |  | 24 tests passed |
| G04 | G04-S01 | 文件监控器 | watcher/增量更新/--watch选项 | done | G03 |  | accepted | passed | 2026-03-20 |  | 7 tests passed |
| G05 |  | v0.4 生产可用 | CLI 完善 + 错误处理 + 文档 | planned | G04 |  | pending | not_started |  |  | 下一个目标 |
